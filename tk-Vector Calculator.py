...
class Window(tk.Tk):
    ...
    def __init__(self):
        ...
        self.config(bg="Mediumspringgreen")
        ...
        # Frames
        self.f_top = tk.Frame(self.baseframe, bg="Mediumspringgreen")
        self.f_main = tk.Frame(self.baseframe, bg="Mediumspringgreen")
        ...
        for i in range(3):
            ...
            spin.delete(0, "end")
            spin.insert(0, 0)
            tk.Label(self.f_top, text=self.l_uni[i], bg="Mediumspringgreen").grid(row=0, column=(i * 2) + 1, padx=10)
    ...
    def show_vect(self):
        ...
        while i < len(l_vals):
            if isinstance(l_vals[i], str):
                ...
                i += 2
        newwin = tk.Toplevel(bg="Mediumspringgreen")
        newwin.iconbitmap(r"C:\Users\Admin\Downloads\475497.ico")
        la_result = tk.Label(newwin, bg="Mediumspringgreen", font=("Calibri", 18), fg="Black")
